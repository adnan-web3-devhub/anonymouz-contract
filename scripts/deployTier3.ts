...
async function main() {
    console.log("Deploying LumanaNFT Tier 3 (Polygon)...");

    // Configuration
    const NAME = "4 THA LUMANA'I - Tier 3";
    const SYMBOL = "LUMANA3";
    const PRICE = 62; // $62 USDT
    ...
    console.log(`✅ Tier 3 NFT deployed to: ${address}`);
    ...
    console.log("  2. Set launch time (SAME as Tier 1 & 2): setLaunchTime(timestamp)");
    ...
    console.log("Total NFTs: 186 (62 × 3 tiers)");
}
